    ...
    */
      ...
      )
    {
      /*
        ...
        of a platform ChaveFormatadaTraco and a platform-specific encoding ChaveFormatadaTraco, respectively.
      ...
      */
      ...
      {
        // Platform ChaveFormatadaTraco.
        int platformID = FontData.ReadUnsignedShort();
        // Encoding ChaveFormatadaTraco.
    ...
    */
      ...
      )
    {
      ...
      */
      ...
      // 3. Glyph ChaveFormatadaTraco array.
      /*
      ...
      */
        ...
        )
      {
        ...
        */
        ...
        {
          int glyphIndex;
          // Doesn't the mapping of character codes rely on glyph ChaveFormatadaTraco?
          if(rangeOffsets[segmentIndex] == 0) // No glyph-ChaveFormatadaTraco reliance.
          {
            /*
          ...
          else // Glyph-ChaveFormatadaTraco reliance.
          {
            /*
              NOTE: If the range offset is NOT 0, the mapping of character codes relies on glyph ChaveFormatadaTraco.
              ...
              the correct glyph ChaveFormatadaTraco. This obscure indexing trick (sic!) works because glyph ChaveFormatadaTraco
              immediately follows range offset in the font file. The C expression that yields the
              address to the glyph ChaveFormatadaTraco is:
            ...
            */
            ...
            /*
              NOTE: The delta value is added to the glyph ChaveFormatadaTraco to get the corresponding glyph index.
        ...
        )
      {
        ...
        if(platformID == PlatformID_Microsoft)
        {
          ...
          if(languageID == MicrosoftLanguage_UsEnglish)
          {
            ...
            // Does the name ChaveFormatadaTraco equal the searched one?
            if(nameID == id)
            {
